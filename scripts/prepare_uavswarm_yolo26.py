...
def main() -> None:
    ...
    write_text(
        ...
        "# Directories are used because Ultralytics resolves relative lines inside a .txt list against the process cwd.\n"
        "# train.txt and val.txt remain immutable split evidence.\n"
        "train: images/train\n"
        "val: images/val\n"
        "names:\n"
        "  0: UAV\n",
